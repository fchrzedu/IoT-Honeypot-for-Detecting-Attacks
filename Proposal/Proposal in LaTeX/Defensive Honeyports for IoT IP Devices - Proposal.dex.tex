...
\begin{itemize}
	...
	\item To deploy a minimum of two separate honeypots:
		\begin{description}
		\item[1.] Low-interaction Vanilla Honeypot,
		\item[2.] High-interaction Honeypot within a secure container.
		\end{description}
	\item To create a virtual network, where each IoT device and VM have logical addressing and are protected through subnets,
	\item To collect and store the following malware properties for quantitve comparison and analysis:
		\begin{description}
